...
DJANGO_PROJECT = 'Thailand Furniture Online'
DJANGO_SETTINGS_MODULE = ''

ADMINS = (
     ('debug', 'testtfo@yopmail.com'),         # tuple (name, email) - important for error reports sending, if DEBUG is disabled.
)
...
#MEDIA_URL="/media/"
MEDIA_URL = 'http://cdn.thailandfurnitureonline.com/media/'

# STATIC_ROOT can be whatever different from other dirs
STATIC_ROOT = os.path.join(DIRNAME, 'static-collect/')
#STATIC_URL = '/static/'
STATIC_URL = 'http://cdn.thailandfurnitureonline.com/static/'
...
SECRET_KEY = '4zoh4lc75g*r54-pmh3vhb68bwz337bip%@j$(^2+sc0n=$gtd'
